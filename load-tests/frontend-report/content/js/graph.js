...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 150.0, "minX": 0.0, "maxY": 150.0, "series": [{"data": [[0.0, 150.0]], "isOverall": false, "label": "Frontend Health Check", "isController": false}, {"data": [[0.0, 150.0]], "isOverall": false, "label": "Load Frontend App", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 4.9E-324, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 3.0, "minX": 1.75939182E12, "maxY": 16.23745819397994, "series": [{"data": [[1.75939188E12, 16.23745819397994], [1.75939182E12, 3.0]], "isOverall": false, "label": "Thread Group", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.75939188E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 2.8888888888888893, "minX": 1.0, "maxY": 9.5, "series": [{"data": [[8.0, 4.75], [9.0, 4.5], [10.0, 5.75], [11.0, 4.333333333333333], [3.0, 9.5], [12.0, 5.333333333333334], [13.0, 4.666666666666666], [14.0, 4.666666666666667], [15.0, 5.0], [4.0, 6.0], [16.0, 4.875], [17.0, 3.375], [18.0, 3.875], [19.0, 3.818181818181818], [5.0, 6.5], [20.0, 4.666666666666667], [21.0, 4.06], [6.0, 5.5], [7.0, 6.0]], "isOverall": false, "label": "Frontend Health Check", "isController": false}, {"data": [[16.26, 4.513333333333332]], "isOverall": false, "label": "Frontend Health Check-Aggregated", "isController": false}, {"data": [[8.0, 3.5], [2.0, 4.0], [9.0, 4.6], [10.0, 4.6], [11.0, 3.0], [12.0, 5.0], [3.0, 3.0], [13.0, 3.571428571428571], [14.0, 3.857142857142857], [15.0, 3.4285714285714284], [16.0, 4.142857142857142], [4.0, 6.0], [1.0, 4.0], [17.0, 3.0], [18.0, 3.0], [19.0, 2.8888888888888893], [5.0, 5.0], [20.0, 3.6666666666666665], [21.0, 3.0199999999999987], [6.0, 3.3333333333333335], [7.0, 4.75]], "isOverall": false, "label": "Load Frontend App", "isController": false}, {"data": [[16.126666666666665, 3.4866666666666664]], "isOverall": false, "label": "Load Frontend App-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 21.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 2.033333333333333, "minX": 1.75939182E12, "maxY": 4200.95, "series": [{"data": [[1.75939188E12, 4200.95], [1.75939182E12, 14.05]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.75939188E12, 592.9666666666667], [1.75939182E12, 2.033333333333333]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.75939188E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 3.4866666666666664, "minX": 1.75939182E12, "maxY": 14.0, "series": [{"data": [[1.75939188E12, 4.449664429530201], [1.75939182E12, 14.0]], "isOverall": false, "label": "Frontend Health Check", "isController": false}, {"data": [[1.75939188E12, 3.4866666666666664]], "isOverall": false, "label": "Load Frontend App", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.75939188E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 3.466666666666668, "minX": 1.75939182E12, "maxY": 13.0, "series": [{"data": [[1.75939188E12, 4.442953020134227], [1.75939182E12, 13.0]], "isOverall": false, "label": "Frontend Health Check", "isController": false}, {"data": [[1.75939188E12, 3.466666666666668]], "isOverall": false, "label": "Load Frontend App", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.75939188E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.75939182E12, "maxY": 9.0, "series": [{"data": [[1.75939188E12, 0.36912751677852346], [1.75939182E12, 9.0]], "isOverall": false, "label": "Frontend Health Check", "isController": false}, {"data": [[1.75939188E12, 0.0]], "isOverall": false, "label": "Load Frontend App", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.75939188E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.75939182E12, "maxY": 14.0, "series": [{"data": [[1.75939188E12, 8.0], [1.75939182E12, 14.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.75939188E12, 1.0], [1.75939182E12, 14.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.75939188E12, 6.0], [1.75939182E12, 14.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.75939188E12, 7.0], [1.75939182E12, 14.0]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.75939188E12, 4.0], [1.75939182E12, 14.0]], "isOverall": false, "label": "Median", "isController": false}, {"data": [[1.75939188E12, 7.0], [1.75939182E12, 14.0]], "isOverall": false, "label": "95th percentile", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.75939188E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 3.0, "minX": 1.0, "maxY": 6.0, "series": [{"data": [[1.0, 5.0], [2.0, 5.5], [4.0, 6.0], [8.0, 3.0], [9.0, 4.0], [5.0, 4.0], [10.0, 3.0], [3.0, 4.0], [6.0, 5.0], [7.0, 4.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 10.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 3.0, "minX": 1.0, "maxY": 6.0, "series": [{"data": [[1.0, 5.0], [2.0, 5.5], [4.0, 6.0], [8.0, 3.0], [9.0, 4.0], [5.0, 4.0], [10.0, 3.0], [3.0, 4.0], [6.0, 5.0], [7.0, 4.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 10.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 0.016666666666666666, "minX": 1.75939182E12, "maxY": 4.983333333333333, "series": [{"data": [[1.75939188E12, 4.983333333333333], [1.75939182E12, 0.016666666666666666]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.75939188E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 0.016666666666666666, "minX": 1.75939182E12, "maxY": 4.983333333333333, "series": [{"data": [[1.75939188E12, 4.983333333333333], [1.75939182E12, 0.016666666666666666]], "isOverall": false, "label": "200", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.75939188E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 0.016666666666666666, "minX": 1.75939182E12, "maxY": 2.5, "series": [{"data": [[1.75939188E12, 2.4833333333333334], [1.75939182E12, 0.016666666666666666]], "isOverall": false, "label": "Frontend Health Check-success", "isController": false}, {"data": [[1.75939188E12, 2.5]], "isOverall": false, "label": "Load Frontend App-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.75939188E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 0.016666666666666666, "minX": 1.75939182E12, "maxY": 4.983333333333333, "series": [{"data": [[1.75939188E12, 4.983333333333333], [1.75939182E12, 0.016666666666666666]], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.75939188E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
